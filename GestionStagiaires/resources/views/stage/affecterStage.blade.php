...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-6">
                <h1 class="text-center">Ajouter Stage</h1>
                <form action="{{route('creerStage')}}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Type de Stage</label>
                        <input type="text" name="type" placeholder="enter Type de stage" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Date Debut</label>
                        <input type="date" name="date_debut"  class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputTelephone1" class="form-label">Date Fin</label>
                        <input type="date" name="date_fin"  class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="mb-3">
